...
module.exports = "<app-navigation></app-navigation>\n<div class=\"container\">\n\t<h6 class=\"title\">{{\"contact\"|translate}}</h6>\n\t<div class=\"staticPage col-md-12\" style=\"text-align: center;min-height:70vh \">\n\t\t<div class=\"contactPage\">\n\t\t\t<div>{{\"reactor\"|translate}}</div><br>\n\t\t\t<div class=\"contact\"><i class=\"fas fa-link\"></i> \n\t\t\t <span>\n\t\t\t\t<a href=\"https://reactor.org.mk\" target=\"_blank\">www.reactor.org.mk</a>\n\t\t\t</span>\n\t\t</div>\n\t\t<div class=\"contact\">\n\t\t\t<i class=\"fas fa-envelope\"></i>  \n\t\t\t<span>\n\t\t\t\t<a href=\"mailto:info@reactor.org.mk\"> info@reactor.org.mk</a>\n\t\t\t</span>\n\t\t</div>\n\t\t<div class=\"contact\">\n\t\t\t<i class=\"fas fa-phone\"></i>  \n\t\t\t<span >+3892 3245 536</span>\n\t\t</div>\n\t</div>\n</div>\n</div>\n<app-footer></app-footer>\n"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.getGeneralGrade = function (elem) {
        ...
        var listener = this.service.getDefaultGrades(elem).subscribe(function (a) {
    ...
    HomeComponent.prototype.getDomen = function (year) {
        var that = this;
        var listener = this.service.getDomenId(year).take(1).subscribe(function (domen) {
...
module.exports = "<app-navigation></app-navigation>\n<div class=\"container methodology\" style=\"text-align: justify;\">\n  <h6 class=\"title\">{{\"methodology\"|translate}}</h6>\n  <div class=\"col-md-12\" [innerHTML]=\"'methodology_text'|translate\">\n    \n  </div>\n  <div class=\"col-md-12\">\n    <h6 class=\"title orangeText\">{{\"methodology_frame_title\"|translate}}</h6>\n    <p>{{\"methodology_frame\"|translate}}</p>\n    <p><span style=\"font-family: ArsenalB;cursor: pointer\" [routerLink]=\"['/dictionaryPage', 'domen_indicator0']\">{{\"gender_gap\"|translate}}.</span> \n\n    <span [innerHtml]=\"'methodology_gender_gap_desc'|translate\">:</span></p>\n    <ol [innerHTML]=\"'methodology_gender_gap_indicators'|translate\"></ol>\n      <p>{{\"methodology_not_included_in_21\"|translate}}</p>\n    <ol [innerHTML]=\"'methodology_not_included_in_21_indicators'|translate\"> \n      \n    </ol>\n    <p>{{\"methodology_not_included_in_21_indicators_des\"|translate}}</p>\n\n    <p><span style=\"font-family: ArsenalB; cursor:pointer;\" [routerLink]=\"['/dictionaryPage', 'domen_indicator1']\">{{\"enabling_conditions\"|translate}}. </span></p>\n    <p [innerHTML]=\"'methodology_enabling_conditions'|translate\"> </p>\n    <ol [innerHTML]=\"'methodology_enabling_conditions_indicators'|translate\">\n      \n    </ol>\n    <p>{{\"methodology_enabling_conditions_indicators_desc\"|translate}}</p>\n   \n    <p><span style=\"font-family: ArsenalB;cursor: pointer;\" [routerLink]=\"['/dictionaryPage', 'domen_indicator1']\">{{\"gender_responsive_mun\"|translate}}. </span>\n    <span [innerHtml]=\"'methodology_gender_responsive_mun'|translate\"></span>:</p>\n    <ol [innerHTML]=\"'methodology_gender_responsive_mun_indicators'|translate\">\n    </ol>\n  </div>\n  <div class=\"col-md-12\">\n    <h6 class=\"title orangeText\">{{\"methodology_index_calc\"|translate}}</h6>\n    <div [innerHTML]=\"'methodology_index_1_calc'|translate\"></div>\n      \n    <div [innerHTML]=\"'methodology_index_2_calc'|translate\">\n      \n    </div>\n    <div [innerHTML]=\"'methodology_index_3_calc'|translate\">\n      \n    </div>\n    <div [innerHTML]=\"'methodology_index_4_calc'|translate\">\n      \n    </div>\n  </div>\n  <div class=\"\" style=\"margin: 50px;\n    font-size: 8px;\n    margin-left: 15px;\"> <sup>1</sup>Joint Research Centre-European Commission. (2008). Handbook on constructing composite indicators: methodology and user guide. OECD publishing.</div>\n</div>\n<app-footer></app-footer>\n"
...
var MunicipalityComponent = /** @class */ (function () {
    ...
    MunicipalityComponent.prototype.loadData_year = function (year) {
        var _this = this;
        var that = this;
        this.route.paramMap.subscribe(function (id) {
            _this.idMunicipality = id.get('idMunicipality');
...
module.exports = __webpack_require__(/*! /Users/aleksandraristeska/Documents/GitHub/genderindex/src/main.ts */"./src/main.ts");
